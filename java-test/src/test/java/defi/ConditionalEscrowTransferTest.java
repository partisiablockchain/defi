...
public final class ConditionalEscrowTransferTest extends JunitContractTest {
  ...
  private static final ContractBytes CONDITIONAL_ESCROW_CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/conditional_escrow_transfer.wasm"),
          Path.of("../target/wasm32-unknown-unknown/release/conditional_escrow_transfer.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/conditional_escrow_transfer_runner"));
