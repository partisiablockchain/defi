...
public final class ZkOrderMatchingTest {
  ...
  public static final ContractBytes CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/zk_order_matching.zkwa"),
          Path.of("../target/wasm32-unknown-unknown/release/zk_order_matching.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/zk_order_matching_runner"));
