...
public final class NftV2Test {
  static final ContractBytes CONTRACT_BYTES =
      ContractBytes.fromPaths(
          Path.of("../target/wasm32-unknown-unknown/release/nft_v2_contract.wasm"),
          Path.of("../target/wasm32-unknown-unknown/release/nft_v2_contract.abi"),
          Path.of("../target/wasm32-unknown-unknown/release/nft_v2_contract_runner"));
